...
#  preference :alice_msk_email, :string, default: "config.alice_msk_email?"
#  preference :alice_msk_phone, :string, default: "config.alice_msk_phone?"
#  preference :alice_msk_phone1, :string, default: "config.alice_msk_phone1?"  
