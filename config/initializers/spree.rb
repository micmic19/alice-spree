...
Spree.config do |config|
  ...
  #config.alice_msk_phone = '+7 (495) 287-81-41'
  #config.alice_msk_phone1 = '+7 (495) 287-81-39'  
  #config.alice_msk_email = 'sale@msk.alice.ru'    
...
Spree::FiltersConfiguration::Config.hidden_properties += ['news']
