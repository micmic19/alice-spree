...
gem 'spree_products_filters', '0.2.8', github: 'micmic19/spree_products_filters', branch: 'another'
# gem 'spree_products_filters', github: 'superchell/spree_products_filters'
